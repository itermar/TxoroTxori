...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        // ground
        let groundTexture = SKTexture(imageNamed: "fondoScroll")
        ...
        pipeTextureUp = SKTexture(imageNamed: "chimenea")
        pipeTextureUp.filteringMode = .Nearest
        pipeTextureDown = SKTexture(imageNamed: "txistu")
        ...
        // setup our bird
        let birdTexture1 = SKTexture(imageNamed: "txoriVuelo1")
        birdTexture1.filteringMode = .Nearest
        let birdTexture2 = SKTexture(imageNamed: "txoriVuelo2")
        ...
        score = 0
        scoreLabelNode = SKLabelNode(fontNamed:"Avenir")
    ...
    func startPintxo (){
        var alertSound = NSURL(fileURLWithPath: NSBundle.mainBundle().pathForResource("Pintxo2", ofType: ".mp3")!)
        println(alertSound)
